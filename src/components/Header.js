...
export default function Header() {
  ...
  return (
    ...
    <View style={{flexDirection: "row", margin: 5,  marginTop: 8}}>
    ...
    <View style={{ flexDirection: "row", justifyContent: "space-around", width: 150, marginTop: 9, marginRight: 8}}>
        <Ionicons style={{marginLeft:30}} name="md-videocam" size={24} color={myColor} />
        <Ionicons style={{marginLeft:30}} onPress = {() => navigation.navigate("search")} name="md-search" size={24} color={myColor} />
